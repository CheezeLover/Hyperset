...
# 4. SUPERSET_SECRET_KEY - openssl rand -base64 42
```
...
## 📦 Superset Standalone Setup (Optional)
...
- **Port 8088 is NOT exposed** - all access goes through Caddy
...
**🔴 Superset asking for login instead of using SSO**
