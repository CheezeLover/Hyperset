        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {pages.map((page) => (
            <div key={page.name}
              ...
              <div style={{
                width: 36, height: 36, borderRadius: 8, background: page.active ? "var(--md-primary)" : "var(--md-surface-cont)",
                display: "flex", alignItems: "center", justifyContent: "center", color: page.active ? "white" : "var(--md-on-surface)",
