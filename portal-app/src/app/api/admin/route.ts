...
export async function GET(request: NextRequest) {
  ...
  const response = {
    ...
    embeddingModel:      s?.embeddingModel      ?? process.env.LLM_EMBEDDING_MODEL  ?? "",
    embeddingApiUrl:     s?.embeddingApiUrl     ?? process.env.LLM_EMBEDDING_API_URL ?? "",
...
export async function POST(request: NextRequest) {
  ...
  await setAdminSettings({
    ...
    embeddingModel:     body.embeddingModel     !== undefined ? body.embeddingModel                            : prev.embeddingModel,
    embeddingApiUrl:    body.embeddingApiUrl    !== undefined ? body.embeddingApiUrl                           : prev.embeddingApiUrl,
    embeddingApiKey:    body.embeddingApiKey && body.embeddingApiKey !== "***" ? body.embeddingApiKey          : prev.embeddingApiKey,
